...
class MIMIC_CXR_Dataset_choice(Dataset):
    def __init__(self , csv_path, tokenizer_path, img_dir = '/home/asellerg/data/inputs/mimic-cxr-jpg/test/files/', img_tokens = 32, seq_length = 512,voc_size = 32000, mode = 'Train',start = 0,text_type = 'blank'):
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'Test':
            item = {
                'input_ids': 'Question: '+ Question + ' Choices: A: Yes B: No C: Yes D: No The Answer is:',
